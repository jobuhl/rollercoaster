...
public class Einteiler2 {
    ...
    public Einteiler2(SingleRiderSchlange singleRiderSchlange, MultiRiderSchlange multiRiderSchlange, Zug zug) {
    ...
    public void fillTrain() {
        ...
        if (zug.getStatus().equals("green") && this.status.equals("free") && multiRiderSchlange.getWartelaenge() <= 100) {
           ...
           fillOverHundert();
            ...
            System.out.println("JOACHIM STINKT");
        }
    }
